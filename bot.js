   ...
   .then(function (res) { 
     ...
     else
     {
       if (res.data["confirmations"] === 1 && res.data["product"]["confirmations"]) {
         ...
         message.reply("_G.Key = '"+key+"'\nloadstring(game:HttpGet('https://wannkey.herokuapp.com/script.lua', true))()") // Change PROJECTNAME to the project u made on heroku!!!
...
client.login("OTQzNDg2MDgwNDMzMzk3ODUx.GaFR7b.XJlGka0shEJ-9YkFdz1YqzG4Z_P6u8rc3osDfQ")
